    ...
    return(
        <tr>
            ...
            <td>
              ...
              {(localStorage.role==='admin'||localStorage.role==='manager')? <button onClick={()=> dispatch(removeProject(props.project))} className="mini ui right floated blue button">Remove</button> : ''}
